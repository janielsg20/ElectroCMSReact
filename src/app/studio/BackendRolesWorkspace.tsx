...
const views: readonly ViewDefinition[] = [
  ...
  { id: 'dashboards', label: 'Dashboards', icon: 'grid', description: 'Saved administrative dashboard definitions.' },
