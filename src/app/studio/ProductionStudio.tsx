...
function ThemesWorkspace() { return <GlobalSystemsWorkspace key="themes" initialView="themes" />; }
...
function EditorModuleWorkspace({ module, onOpenBuilder }: { module: StudioModuleId; onOpenBuilder(): void }) {
  ...
  if (module === 'settings') return <GlobalSystemsWorkspace key="settings" initialView="project" />;
