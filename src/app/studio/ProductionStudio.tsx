...
const moduleFeatures: Record<Exclude<StudioModuleId, 'builder' | 'themes' | 'pages' | 'media' | 'content' | 'queries' | 'forms' | 'filters' | 'users'>, readonly FeatureGroup[]> = {
  blueprints: [
...
function ModuleWorkspace({ module }: { module: Exclude<StudioModuleId, 'builder' | 'themes' | 'pages' | 'media' | 'content' | 'queries' | 'forms' | 'filters' | 'users'> }) {
...
function BackendWorkspace() { return <BackendRolesWorkspace initialView="overview" />; }
