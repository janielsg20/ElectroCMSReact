...
export type FieldTypeValueValidator = (value: JsonValue, config: JsonObject) => FieldTypeValidationResult;
...
export function invalidFieldTypeValue(code: string, path: string, message: string): FieldTypeValidationResult {
