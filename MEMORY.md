...
### MF-042 Advanced Fields — DONE
- Public content registry keeps historical v1 modeled contracts and promotes only Group, Repeater, Calculated and Conditional to v2 `available`.
- Relation/User/Taxonomy remain modeled for MF-043.
...
- Studio Pro Field Groups exposes the advanced v2 configuration controls; Records uses recursive nested editors and live calculated/conditional state.
- E2E validates actual IndexedDB persistence and destructive nested-schema rejection.
- PR #48; Gate #1533 PASS; merge `899a4fdc2d3ad65ced9f3086c43e7fc8d4b859ad`.
...
- Field Group deletion/update respeta Taxonomies, Records y advanced references.
- MF-043 debe preservar los límites de seguridad de MF-042.
- No adelantar Dynamic Bindings MF-044 durante Relations.
...
- Integrado: MF-037 a MF-042.
- Próxima microfase: **MF-043 — Relations**.
- Recuperar el contrato/reference runtime histórico exacto sin adelantar MF-044.
